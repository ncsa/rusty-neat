...
This project is indexed by GitNexus as **rusty-neat** (1372 symbols, 3232 relationships, 117 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
