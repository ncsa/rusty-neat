...
mod tests{
    ...
    fn test_reader_writer() {
        let input_file = "/home/joshfactorial/code/rusty-neat/common/src/models/model_data/default_fragment_length_model.json.gz";
        let output_file = "/home/joshfactorial/code/rusty-neat/common/src/models/model_data/test.json.gz";
        let model: DiscreteFragmentLengthModel = model_gzp_reader(input_file).unwrap();
