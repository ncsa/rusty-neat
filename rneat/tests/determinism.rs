...
//! because rneat iterates HashMap keys when assembling per-contig outputs, and Rust's
...
fn same_seed_single_threaded_produces_same_record_multiset() {
    ...
    let seed = "rusty neat single threaded";
...
fn same_seed_multi_threaded_produces_same_record_multiset() {
    ...
    let seed = "rusty neat multi threaded";
